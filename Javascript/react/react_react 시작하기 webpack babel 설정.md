...
react, react-dom 설치
설치시 package.json에 `name`프로퍼티의 공백문자나, 키워드가 같은 문자가 들어가면 에러나니 그 부분만 주의합니다.
...
[레퍼런스:babel-preset-env는 무엇이고 왜 필요한가?](https://velog.io/@pop8682/번역-왜-babel-preset이-필요하고-왜-필요한가-yhk03drm7q)
...
프로젝트 루트 디렉토리에서 src라는 디렉토리를 생성해서 index.html를 추가해줍니다.
이 구조는 템플릿 처럼 똑같습니다.
...
css 를 styled-component로 할지 sass로 할지 결정해서
추가로 css를 적용해봐야겠습니다.

참고:

[레퍼런스: React webpack 밑바닥에서 부터 설정해보기 - @pop8682](https://velog.io/@pop8682/번역-React-webpack-설정-처음부터-해보기)
[레퍼런스: Babel과 Webpack을 이용한 ES6 환경 구축](https://poiemaweb.com/es6-babel-webpack-2)